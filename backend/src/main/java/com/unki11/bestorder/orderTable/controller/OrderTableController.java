package com.unki11.bestorder.orderTable.controller;

import com.unki11.bestorder.orderTable.domain.TableGrpDto;
import com.unki11.bestorder.orderTable.service.OrderTableService;
...
public class OrderTableController {
    ...
    public ResponseEntity<List<TableGrpDto>> getTableStatusWithOrder(@PathVariable Long storeId) {
        List<TableGrpDto> result = orderTableService.getTablesWithOrderAmount(storeId);
